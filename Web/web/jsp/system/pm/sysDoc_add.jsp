  ...
  <script language="javascript" src="<%= CONTEXT_PATH %>js/ctrl_util.js"></script>	
	...
	function goSubmit(){
		...
		if(!checkString(getElement('form.record.docNo'),"文档编号",20,true)) return;
		 ...
		 // if(!checkString(getElement('form.record.docStatus'),"状态",6,true,true)) return;
		 // if(!checkString(getElement('form.record.remark'),"备注",200,false)) return;
		
		  document.forms[0].action=fulllink+"?action=SAVECHILDDOC";
...
<s:form action="sysDoc" id="docForm" method="post" namespace="/system">
  	<s:hidden name="form.record.upCatagoryId" />
